  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 py-24 flex flex-col items-center">
      <div className="w-full space-y-8 text-white/70">
        ...
        <p className="text-sm text-white/40">Last Updated: October 2023</p>
        ...
        <section className="space-y-4">
          ...
          <p>
            The Arivu core engine and dashboard are released under the open source MIT License (or corresponding open source license as stated in the repository). You are free to use, modify, and distribute the software subject to the license conditions.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            The software is provided &quot;as is&quot;, without warranty of any kind, express or implied. In no event shall the authors or copyright holders be liable for any claim, damages or other liability arising from your use of the software.
          </p>
        </section>
