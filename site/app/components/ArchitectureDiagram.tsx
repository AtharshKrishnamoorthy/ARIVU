...
function GridCell({
  name, src, invert, size = 36,
}: {
  name: string; src: string; invert?: boolean; size?: number;
}) {
  return (
    <div className="group flex flex-col items-center justify-center gap-3 border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.05] hover:border-white/[0.12] transition-all duration-300 p-5 md:p-6">
      <Image
        ...
        unoptimized
      />
      <span className="text-[9px] md:text-[10px] font-semibold text-white/30 group-hover:text-white/50 tracking-[0.12em] uppercase transition-colors duration-300">
        {name}
      </span>
    </div>
  );
...
function VArrowDesktop() {
  return (
    <div className="hidden lg:flex items-center justify-center py-0 border-x border-white/[0.06] bg-white/[0.01]">
    ...
    <section className="w-full py-28 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-16">
          <p className="text-[10px] uppercase tracking-[0.3em] text-white/20 font-bold mb-3">Architecture</p>
        ...
        >
          ...
          <div className="hidden lg:block">
            ...
            <div className="grid grid-cols-[1fr_auto_auto_auto_2fr_auto_auto_auto_1fr] items-stretch">
              ...
              <div>
                ...
                {databases.map(d => <GridCell key={d.name} {...d} size={40} />)}
              </div>
              ...
              <div>
                ...
                {channels.map(c => <GridCell key={c.name} {...c} size={40} />)}
              </div>
          ...
          <div className="lg:hidden flex flex-col items-center">
            ...
            <div className="w-full max-w-sm">
              ...
              <div className="grid grid-cols-3">
                {databases.map(d => <GridCell key={d.name} {...d} size={30} />)}
              </div>
            </div>
