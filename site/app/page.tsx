...
import { ArrowRight, Terminal, Database, Zap, Code2 } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <section className="relative w-full flex flex-col items-center justify-center pt-32 pb-20 px-4 sm:px-6 overflow-hidden">
        ...
        <motion.div variants={container} initial="hidden" animate="show" className="text-center max-w-4xl z-10">
          ...
          <motion.h1 variants={item} className="text-5xl md:text-7xl font-extrabold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60">
            The Agentic Database <br className="hidden md:block" /> Command Center
          </motion.h1>
          <motion.p variants={item} className="text-lg md:text-xl text-white/50 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="https://github.com/AtharshKrishnamoorthy/ARIVU" target="_blank"
      ...
      <section id="sdk" className="w-full max-w-5xl px-4 sm:px-6 py-16">
        <div className="rounded-xl border border-white/10 bg-black/50 overflow-hidden backdrop-blur-sm shadow-2xl">
          ...
          <div className="p-6 overflow-x-auto text-sm font-mono text-white/80 whitespace-pre">
            ...
            <span className="text-white/40"># Run AI pipeline</span>{`\n`}
      ...
      <section id="features" className="w-full max-w-6xl px-4 sm:px-6 py-24 space-y-32">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-[1.5] w-full relative">
            ...
            <div className="relative rounded-xl border border-white/10 bg-white/5 p-2 shadow-2xl overflow-hidden ring-1 ring-white/10">
              <Image src="/arivu-chat-dark.png" alt="Chat Interface Preview" width={1200} height={800} className="w-full h-auto rounded-lg object-cover" unoptimized />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-white/60 leading-relaxed text-lg">
              Manage unlimited PostgreSQL, MySQL, and SQLite connections seamlessly. Swap between active environments on the fly securely.
            </p>
          </div>
          <div className="flex-[1.5] w-full relative">
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 blur-3xl opacity-30" />
            <div className="relative rounded-xl border border-white/10 bg-white/5 p-2 shadow-2xl overflow-hidden ring-1 ring-white/10">
              <Image src="/arivu-conn-dark.png" alt="Connections Interface Preview" width={1200} height={800} className="w-full h-auto rounded-lg object-cover" unoptimized />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-white/60 leading-relaxed text-lg">
              Never wonder why an agent failed. Deep-dive into granular pipeline traces, node latencies, and SQL syntax errors in real-time.
            </p>
          </div>
          <div className="flex-[1.5] w-full relative">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 to-red-500/20 blur-3xl opacity-30" />
            <div className="relative rounded-xl border border-white/10 bg-white/5 p-2 shadow-2xl overflow-hidden ring-1 ring-white/10">
              <Image src="/arivu-monitoring-dash-dark.png" alt="Monitoring Dashboard Preview" width={1200} height={800} className="w-full h-auto rounded-lg object-cover" unoptimized />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="models" className="w-full py-24 border-t border-white/10 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/50 mb-12 max-w-2xl mx-auto">Arivu routes intelligently to your favorite LLM providers automatically.</p>
      ...
      <section id="integrations" className="w-full py-24 border-t border-white/10 bg-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/50 mb-12 max-w-2xl mx-auto">Supports direct deployment to the communication platforms you already use.</p>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 items-center justify-items-center opacity-80 hover:opacity-100 transition-all duration-500">
            {platforms.map((logo) => (
              <div key={logo.name} className="flex flex-col items-center gap-3 transition-transform hover:scale-110">
                <div className="h-10 flex items-center justify-center">
                  <Image src={logo.src} alt={logo.name} width={40} height={40} className="max-h-full object-contain" unoptimized />
                </div>
                <span className="text-[10px] font-medium text-white/50">{logo.name}</span>
              </div>
            ))}
